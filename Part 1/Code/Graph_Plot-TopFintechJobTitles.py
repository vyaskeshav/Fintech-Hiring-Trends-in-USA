...
if os.path.exists("jobtitlegraph.csv"):
    os.remove("jobtitlegraph.csv")
    
csvData= [['Job Title', 'Fintech Score']]

for jobtitle, fintechscore in sorted_dict:
    csvData.append([jobtitle,fintechscore])
    
with open('jobtitlegraph.csv', 'w', newline='',encoding='utf8') as csvFile:
